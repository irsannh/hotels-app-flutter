  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          'Detail Booking', style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8,),
          itemRoomDetail(context, 'Total Payment', AppFormat.currency(booking.totalPayment.toDouble())),
          const SizedBox(height: 8,),
        ],
      ),
      );
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(booking.name, style: Theme.of(context).textTheme.titleMedium!.copyWith(
                      fontWeight: FontWeight.bold
                    ),),
                    Text(booking.location, style: const TextStyle(
                      color: Colors.grey, fontWeight: FontWeight.w300
                    ),)
                  ],
                ),
