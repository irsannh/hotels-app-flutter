...
import 'package:hotelioapp/controller/c_nearby.dart';
...
class NearbyPage extends StatelessWidget {
  ...
  GetBuilder<CNearby> hotels() {
    return GetBuilder<CNearby>(
          builder: (_) {
            List<Hotel> list = _.category == 'All Place' ? _.listHotel : _.listHotel.where((e) => e.category == cNearby.category).toList();
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          Text('Start from ', style: const TextStyle(
                                            color: Colors.grey,
                                            fontSize: 13,
                                          ),),
                                          Text(AppFormat.currency(hotel.price.toDouble()), style: const TextStyle(
    ...
    return Padding(
        ...
        child: Row(
          ...
          children: [
            GestureDetector(
              onTap: (){
                showMenu(context: context, position: RelativeRect.fromLTRB(16, 16, 0, 0), items: [
            ...
            Column(
              ...
              children: [
                Text('Near Me', style: Theme.of(context).textTheme.titleLarge!.copyWith(
                  fontWeight: FontWeight.w900
                ),),
                Obx(
                        () {
                    return Text('${cNearby.listHotel.length} hotels', style: const TextStyle(color: Colors.grey, fontSize: 12),);
                  }
                )
              ],
            )
