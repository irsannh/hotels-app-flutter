...
import 'package:hotelioapp/controller/c_history.dart';
          ...
          return GroupedListView<Booking, String>(
              ...
              groupSeparatorBuilder: (String groupByValue) {
                ...
                return Padding(
                  ...
                  child: Text(
                    date, style: Theme.of(context).textTheme.titleMedium!.copyWith(
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Text('My Booking', style: Theme.of(context).textTheme.titleLarge!.copyWith(
                  fontWeight: FontWeight.w900
              ),),
              Obx(() {
                  return Text('${cHistory.listBooking.length} transactions', style: const TextStyle(color: Colors.grey, fontSize: 12),);
                }
              )
            ],
          )
